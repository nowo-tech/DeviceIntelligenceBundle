# Prefer Compose V2; fall back to docker-compose V1 (REQ-MAKE-010).
...
help:
	@echo "Device Intelligence Bundle - Development Commands"
	@echo ""
...
assets: ensure-up
	...
	@echo "Assets: src/Resources/public/js/device-intelligence.min.js"
...
qa: cs-check phpstan test test-ts
