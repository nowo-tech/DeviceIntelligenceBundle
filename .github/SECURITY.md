...
We take the security of DeviceIntelligenceBundle seriously. If you believe you have found a security vulnerability, please report it privately:
...
- Type of issue (e.g., XSS, CSRF bypass, cookie tampering, injection, etc.)
