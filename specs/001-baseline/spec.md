...
- **FR-MSG-001**: `CleanupHandler` / `RecalculateStabilityHandler` with `#[AsMessageHandler]`.
...
- **FR-TEST-TS-001**: Vitest under `src/Resources/assets/` with ≥90% line coverage.

---

## Success Criteria

- **SC-001**: Production PHP under `lib/` + `src/` mapped in `code-inventory.md`.
